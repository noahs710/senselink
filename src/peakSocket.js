...
export const SOCKET_EVENTS = Object.freeze({
  ...
  PEER_LEFT: 'PEER_LEFT',
  PEER_REATTACHED: 'PEER_REATTACHED',
  ...
  GROUP_USER_DEVICE_UPDATE: 'GROUP_USER_DEVICE_UPDATE',
  GROUP_USER_DEVICE_DISCONNECT: 'GROUP_USER_DEVICE_DISCONNECT',
  RULES: 'RULES',
  LOCK: 'LOCK',
  CHAT: 'CHAT',
  ...
  FINAL: 'FINAL',
  SITE_CHAT: 'SITE_CHAT',
  SITE_CHAT_REJECTED: 'SITE_CHAT_REJECTED',
  MATCHMAKE_JOIN: 'MATCHMAKE_JOIN',
  MATCHMAKE_QUEUED: 'MATCHMAKE_QUEUED',
  MATCH_FOUND: 'MATCH_FOUND',
  MATCHMAKE_CANCEL: 'MATCHMAKE_CANCEL',
  MATCHMAKE_CANCELLED: 'MATCHMAKE_CANCELLED',
  MATCHMAKE_REJECTED: 'MATCHMAKE_REJECTED',
  RATING: 'RATING',
});

// Final signals the end of a dab for a member of the joined room.
// Use SOCKET_EVENTS.FINAL when subscribing to a room socket for dab-completion events.
export const ROOM_DAB_END_EVENT = SOCKET_EVENTS.FINAL;
